export default function About() {
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            <h2 className="text-2xl font-display font-bold mb-4">About Start-DSP Toolbox</h2>
            <p className="text-gray-600 mb-6">
                The Start-DSP Entrepreneurial University Educators Package and Toolbox is designed to enhance the quality and impact of entrepreneurship education in European Higher Education Institutions through practice-oriented resources and guidelines.
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <ul className="list-disc list-inside text-gray-600 space-y-2">
                        <li>Needs-based development of Entrepreneurial Educators Toolbox</li>
            ...
            <div className="mt-6 bg-white rounded-lg shadow p-6">
                <h3 className="text-xl font-display font-medium mb-3">Toolbox Components</h3>
            ...
            <div className="mt-6 bg-white rounded-lg shadow p-6">
                ...
                <p className="text-gray-600">
                    This comprehensive toolbox provides suitable approaches for the further professionalization of
